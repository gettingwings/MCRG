class Game {
  constructor() {
    ...
    //flags
    this.playerMoving = false; // fuel bar , slow forward movement
    //C41//TA
    this.leftKeyActive = false; // bouncing one time
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          if (player.life <= 0) {
            this.blast = true; // blast has occured
            this.playerMoving = false; //fuel
            gameState = 2;
          }
